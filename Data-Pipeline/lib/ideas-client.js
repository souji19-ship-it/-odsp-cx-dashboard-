...
let msal;
try { msal = require(`${__dirname}/../../IDEAS-AI-Plugins/plugins/ideas/node_modules/@azure/msal-node`); }
catch { msal = require('@azure/msal-node'); }  // fallback when IDEAS plugin isn't co-installed
const fs     = require('fs');
