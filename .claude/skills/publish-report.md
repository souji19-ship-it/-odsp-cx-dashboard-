...
2. Run the publish script from the project root:
   ...
   - This also generates `wiki-usage-summary.md` and updates the ODSPRepo wiki via browser automation.

3. Report the result to the user:
   - The SharePoint URL of the published dashboard
   - Number of data files uploaded
   - The ODSPRepo wiki link
...
- ODSPRepo wiki: `https://microsoft.sharepoint-df.com/sites/ODSPRepo/Wiki/Forms/smartwiki.aspx/AI%20Usage.md?pageId=70`
